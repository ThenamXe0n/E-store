...
export default function ProductDetails() {
  ...
  const handleCart = (e) => {
    e.preventDefault();
    if (cart.findIndex((items) => items.product.id === product.id) < 0) {
      console.log(product.id)
      const NewItems = {product:product.id, quantity: 1, user: user.id };
      dispatch(addToCartAsync(NewItems));
      setButtonText("Item is added");
      alert.success("Item added to cart!");
    } else {
      alert.show("Item is already add in cart");
    }
  };
        ...
        <div className="pt-6">
          ...
          <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <p className="text-2xl tracking-tight text-gray-900 line-through">
                ₹
                {Math.floor(
              ...
              <div className="mt-6">
                ...
                <div className="flex items-center">
                  ...
                  <p className="sxr-only">{product.rating} out of 5 stars</p>
                </div>
              </div>
              ...
              <form className="mt-10">
                ...
                <Link to="/cart">
                  ...
                  <button
                    ...
                    className="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                  >
                    Go to cart <ShoppingCartIcon className="h-4 w-4 ml-2" />
                  </button>
                </Link>
              </form>
            </div>
